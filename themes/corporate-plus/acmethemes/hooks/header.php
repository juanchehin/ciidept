                ...
                <div class="main-navigation navbar-collapse collapse">
                    ...
                    $link = function_exists( 'wc_get_cart_url' ) ? wc_get_cart_url() : WC()->cart->get_cart_url();
                        ...
                        <div class="user-login">
                            <a class="cart-contents cart-customlocation" href="<?php echo esc_url( $link ); ?>" title="<?php esc_attr_e( 'View your shopping cart' , 'corporate-plus' ); ?>"><?php echo sprintf (_n( '%d item', '%d items', WC()->cart->cart_contents_count,'corporate-plus' ), WC()->cart->cart_contents_count ); ?> - <i class="fa fa-shopping-cart"></i> <?php echo WC()->cart->get_cart_total(); ?></a>
